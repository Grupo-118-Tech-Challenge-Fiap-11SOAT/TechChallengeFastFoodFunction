...
public class ModelTests
{
    ...
    public void LoginRequest_Properties_CanBeSetAndGet()
    {
        ...
        // Assert
        Assert.Equal("Alice", loginRequest.Name);
        Assert.Equal("Johnson", loginRequest.Surname);
        Assert.Equal("alice.johnson@example.com", loginRequest.Email);
    ...
    public void CustomerRequest_Properties_CanBeSetAndGet()
    {
        ...
        Assert.Equal("Bob", customerRequest.Name);
        Assert.Equal("Brown", customerRequest.Surname);
        Assert.Equal("bob.brown@example.com", customerRequest.Email);
